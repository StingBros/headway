...
(function (root, factory) {
  ...
  var START = [
    ...
    { t: 'Add the work', d: 'Edit → **Add feature**, or click the **Add feature** row under a phase and type the title. Open a row (click its number) for the detail panel: description, size, priority, tags, and a **Stories** section for the pieces underneath.' },
    ...
    { t: 'Link what depends on what', d: 'Hover a bar and drag its edge **circle** onto another bar: left circle = depends on it, right = enables it. The orange chain is the critical path; dashed amber arrows are violations. Edit → **Auto-schedule…** lays everything out in dependency order.' },
  ...
  var VIEWS = [
    ...
    { t: 'Planning', d: 'The Gantt. Bars, story bars, dependency arrows, phase lane, capacity row, Resources panel at the bottom. Drag empty space to pan, `Mod+scroll` to zoom.' },
  ...
  var KEYS = [
    ...
    { g: 'Selection', k: [['Click row number', 'Open the detail panel'], ['Right-click', 'Row, bar, band and card menus'], ['Delete', 'Delete the selected item or arrow'], ['Esc', 'Close a menu · cancel a dependency drag'], ['[ · ]', 'Collapse the left pane · the right panel']] },
  ...
  var FEATURES = [
    ...
    { t: 'Milestones, flags, locks', d: 'A zero-duration item is a milestone (diamond, star or circle). Right-click → **Flag…** puts an orange flag with a reason on any row. **Lock** pins a bar through auto-schedule; **Done** greys it out.' },
    { t: 'Capacity and cost', d: 'Setup → Capacity turns on the roster maths: hours per person per week in the Resources panel, a capacity row over the timeline, and auto-schedule that never overbooks. Budgeting prices it.' },
