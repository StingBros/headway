...
eq(byNum(RM.autoTimeline(trackState(['Development']), { phaseIds: ['p1'], today: 0 }).state)[2].startDay, 0,
  'an untracked type is dependency-only: both Design units start in the same week');
eq(byNum(RM.autoTimeline(trackState(['Development', 'Design']), { phaseIds: ['p1'], today: 0 }).state)[2].startDay, 5,
